...
public class MedicineController {
   ...
   public Optional<Medicine> getmedById(@PathVariable Long medicineId)
   {
    ...
    public ResponseEntity<Medicine>alterMedicine(@PathVariable Long id,@RequestBody Medicine medicine)
    {
        return new ResponseEntity<>(medicineService.AlterMedicine(id,medicine),HttpStatus.CREATED);
    }

    @DeleteMapping("/drop/medicine/{id}")
